...
wp core install --url=localhost:8080 --title="inception" --admin_user="${WORDPRESS_SUPER_USER}" --admin_password="${MARIADB_PASSWORD}" --admin_email="${WORDPRESS_SUPER_USER_EMAIL}" --allow-root --path=/var/www/html/wordpress 
